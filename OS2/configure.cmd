 ...
 * ------------------------------------------------------------------ */
  ...
  Call DMSG('AUTODETECT='autoconf', DBTYPE='dbtype', DRIVE='drive)
 ...
 * ----------------------------------------------------------------- */
  ...
  Call DMSG(Imdir Mandir Bindir Imlibdir)
